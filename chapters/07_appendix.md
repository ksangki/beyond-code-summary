...
- **McKinsey** *State of AI 2025*: 88% 도입 / *39% EBIT 효과*. *workflow redesign이 가장 큰 변수*. *21%만 근본 재설계*. 고성과 기업 *2.8배 ROI*.
- **BCG** *Workforce Transformation 2026*: *60% 가치 실패 / 5% future-built*. *10-20-70 framework*. trailblazer CEO *75% 업스킬링 투자*.
- **Microsoft** *Frontier Firm*: 직원 *80% 시간빚*. *67% vs 40%* 에이전트 친숙도 격차.
- **Deloitte** *Global Human Capital Trends 2025*: *93%·19%* 직무 구조 변화 인식·실행 격차. *73%·7%* 매니저 재정의 격차. *46%* legacy mindset 장애.

### 결정적 학술

- *EPOCH* — Loaiza·Rigobon 2024 MIT Sloan. 인간 고유 능력 5요소(Empathy·Presence·Opinion·Creativity·Hope).
- *Cornell 2025* — Wiernsperger 외 *Management Science*. 성과 보상이 AI 채택을 *유의미하게 늘림*.
- *Vaccaro 2024* — *Nature Human Behaviour*. 인간-AI 결합의 *synergy 평균 부재* (균형 자료).
...
- SKT 양대 CIC — *5년 5조 투자, 2030 매출 5조 목표*.
...
| III | Vaccaro 2024 — synergy 부재 / Fuller·Raman 2024 — *3.6% 실행* / Vallas·Schor 2020 — *permissive potentate* |
...
| III. 코드 너머의 조직 | https://ksangki.github.io/beyond-code-org/ | 코드-너머의-조직-v1.1.0.epub |
| 요약본 (본서) | https://ksangki.github.io/beyond-code-summary/ | 코드-너머의-시리즈-v1.0.0.epub |
